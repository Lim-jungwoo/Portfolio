...
/*   Updated: 2021/06/22 08:47:30 by jlim             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static	int	itoa_strlen(long long int n)
{
	long long	number;
	int			n_strlen;
...
static int	check_digit_n(long long int n, int n_strlen)
{
	int	i;
	int	digit;
...
static char	*sub_ft_itoa(long long int n, char *str, int check_digit)
{
	int			i;
	long long	number;
