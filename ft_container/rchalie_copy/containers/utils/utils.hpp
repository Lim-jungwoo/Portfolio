...
namespace ft
{
	...
	struct Doubly_Linked_node
	{
		public:
			...
			Doubly_Linked_node(const Data_T &val, Doubly_Linked_node *prev, double *next) :
				prev(prev), next(next), data(val) {}
	};
}
