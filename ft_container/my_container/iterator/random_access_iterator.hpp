...
namespace ft
{
	...
	{
		template <class _Iterator, class _const_Iterator> friend class random_access_const_iterator;
		public:
		...
		public:
			...
			random_access_iterator(const random_access_iterator& it) : _random_it(it._random_it) {}

			random_access_iterator&	operator=(const random_access_iterator& it)
			{
				if (*this == it)
					return (*this);
				this->_random_it = it._random_it;
				return (*this);
			}
			pointer	base() const { return (_random_it); }
			reference	operator*() const { return (*_random_it); }
			random_access_iterator	operator+(difference_type n) const
			{ return random_access_iterator(_random_it + n); }
	...
	class random_access_const_iterator : ft::iterator<ft::random_access_iterator_tag, const_Iterator>
	{
		public:
		...
		public:
			...
			random_access_const_iterator(const random_access_const_iterator& cit) : _random_const_it(cit._random_const_it) {}
			random_access_const_iterator(const random_access_iterator<Iterator>& it) :
				_random_const_it(it._random_it) {}
			
			random_access_const_iterator&	operator=(const random_access_const_iterator& cit)
			{
				if (*this == cit)
					return (*this);
				this->_random_const_it = cit._random_const_it;
				return (*this);
			}
			random_access_const_iterator&	operator=(const random_access_iterator<Iterator>& it)
			{
				if (*this == random_access_const_iterator(it))
					return (*this);
				this->_random_const_it = it._random_it;
				return (*this);
			}
	...
	bool	operator==(const ft::random_access_iterator<Iterator1>& lhs,
		const ft::random_access_const_iterator<Iterator1, Iterator2>& rhs)
	{ return (lhs.base() == rhs.base()); }

	template <class Iterator1, class Iterator2>
	bool	operator==(const ft::random_access_const_iterator<Iterator1, Iterator2>& lhs,
